...
const DropDown = () => {
    ...
    return (
        <>
            ...
            <Listbox value={selecteditem} onChange={setSelecteditem} as="div" className=" bg-waitListInput rounded-[23.5px] xsm:w-[100%]  lg:w-[48%]  h-[4.7rem]  min-h-[3.6rem] max-h-[4.7rem] ">
...
const Waitlist = () => {
    ...
    return (
        <div className='w-[100%]  lg:h-[90vh] md:h-[70vh] xsm:h-[70vh]  bg-homeBlackBg flex flex-col items-center justify-center relative min-h-[60rem] lg:mt-48 xsm:mt-24' >
            ...
            <div className="lg:w-[80%] 2xl:w-[70%] 2xl:h-[60%] xsm:w-[90%] h-[80%] flex flex-col xsm:justify-center lg:justify-center gap-10 items-center  bg-FormColor rounded-[30px] shadow-FormShadow mt-8 border-2 border-blue-300" >
                <div className='w-full h-[90%] border-2  flex flex-col xsm:justify-center lg:justify-center gap-10 items-center' >
                    ...
                    <div className="lg:w-[70%] xsm:w-[90%] md:w-[80%] border-2 ">
                    ...
                    <div className="lg:w-[50%] md:w-[50%] xsm:w-[80%] xsm:h-[60%] xsm:flex lg:h-[15%] xsm:flex-col xsm:justify-between xsm:items-center  ">
                        <div className="flex lg:flex-row  items-center justify-between xsm:flex-col xsm:h-[45%] xsm:w-[100%]  xsm:justify-around lg:h-[50%] " >
                            <Input type="text" placeholder="Name" />
                            <Input type="email" placeholder="Email" />
                        </div>
                        <div className="flex lg:flex-row  items-center justify-between lg:mt-8 xsm:mt-0 xsm:flex-col xsm:h-[45%] xsm:w-[100%] xsm:justify-around lg:h-[50%] lg:mb-5  "  >
                            <Input type="tel" placeholder="Phone No." pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" />
                            <DropDown />
                        </div>
                        <Button text="Join Now" />
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className='border-2 border-red-400 top-[30%] left-[20%] absolute '>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className='border-2 border-red-400 bottom-[30%] right-[20%] absolute '>
