...
const InvestmentIdea = () => {
    return (
        <div className="w-full lg:h-[60vh] xsm:h-[40vh] flex justify-center items-center bg-homeBlackBg mt-5 ">
            <div className="lg:w-[80%] md:w-[70%] xsm:w-[90%] h-[100%] lg:flex lg:flex-row  xsm:flex-col justify-center items-center text-center ">
                ...
                <div className="lg:w-[70%] md:w-[100%]  w-[100%] md:h-[25%] xsm:h-[30%]  lg:h-[100%] md:pl-0 lg:pl-10 font-[600] leading-[5rem] flex justify-center items-center" >
