...
const InvestmentIdea = () => {
    return (
        <div className="w-full lg:h-[60vh] xsm:h-[40vh] flex justify-center items-center bg-homeBlackBg ">
            <div className="lg:w-[80%] md:w-[70%] xsm:w-[90%] h-[100%] lg:flex lg:flex-row  xsm:flex-col justify-center items-center text-center ">
                <div className='lg:w-[40%] xsm:w-[100%] lg:h-[80%] xsm:h-[70%] border-r-[1px] border-primaryOrange  flex flex-col justify-around xsm:justify-between items-center lg:pr-10 ' >
                ...
                <div className="lg:w-[70%] md:w-[100%]  xsm:w-[100%] md:h-[25%] xsm:h-[30%]  lg:h-[100%] md:pl-0 lg:pl-10 font-[600] leading-[5rem] flex justify-center items-center" >
