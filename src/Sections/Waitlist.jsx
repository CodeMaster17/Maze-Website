...
const Waitlist = () => {
    ...
    return (
        <div className='w-[100%] lg:h-[90vh] md:h-[70vh] xsm:h-[70vh]  bg-homeBlackBg flex flex-col items-center justify-center border-2 border-blue-400' >
            ...
            <div className="lg:w-[80%] xsm:w-[90%] h-[80%] flex flex-col xsm:justify-center border-2 border-red-500 lg:justify-around items-center  bg-FormColor rounded-[30px] shadow-FormShadow mt-8 " >
                <div className="w-[100%] ">
