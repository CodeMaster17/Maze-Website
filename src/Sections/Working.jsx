...
const Working = () => {
    return (
        <div className="w-full lg:h-[100vh] md:h-[140vh] xsm:h-[120vh] flex flex-col justify-center items-center  border-2 border-white bg-homeBlackBg  "  >
            <p className="text-white text-[3rem] font-[700] " >{"How it Works?"}</p>
            <div className='lg:w-[80%] xsm:w-[90%] lg:h-[65%] xsm:h-[90%]  border-2 border-red-500 lg:flex lg:flex-row justify-between items-center xsm:flex xsm:flex-col' >
