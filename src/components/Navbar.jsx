...
const Navbar = () => {
    return (
        <div className='w-[100%] h-[15vh] bg-homeBlackBg flex items-center  border-2 border-green-500 justify-center' >
            ...
            <div className="flex xl:w-[40%] md:w-[40%] justify-between items-center  pl-[5%] " >
